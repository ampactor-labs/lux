...
CHUNKS=(
  ...
  "bootstrap/src/lower/lowfn.wat"        # Tier 4 (uses $make_record + $record_get + $record_set from record.wat; Phase C.1 — LowFn record tag 350; 6 exports — $lowfn_make + 5 accessors; row as first-class field per src/lower.nx canonical)
